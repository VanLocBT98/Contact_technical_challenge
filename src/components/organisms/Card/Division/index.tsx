...
const CardDivision: React.FC<CardDivisionProps> = ({ thumbnail, title, description, link }) => (
      ...
      <div className='o-cardDivision_wrap'>
        ...
        <div className='o-cardDivision_content'>
          ...
          <div className='o-cardDivision_desc u-mt-5'>
            <Typography type='p' content={description} modifiers={['16x28', '400', 'darkLiver']} />
          </div>
          <div className='o-cardDivision_bottomLine u-mt-12 animate animate-arrowSlide'>
            <Typography type='p' modifiers={['14x21', 'darkLiver']} content={link?.text} />
